...
def page2():
    ...
    # Initialize other_input_gender
    other_input_gender = ""

    # Validation for text input when 'Not Listed' is selected for gender
    ...
    # Initialize other_input_race
    other_input_race = ""

    # Validation for text input when 'A Race/ethnicity not listed here' is selected for race
    ...
    # Initialize other_input_college
    other_input_college = ""

    # Validation for text input when 'Not Listed' is selected for college year
    ...
    # Initialize other_input_major
    other_input_major = ""

    # Validation for text input when 'Not Listed' is selected for major
